...
# Infraestructura
from app.infrastructure.external.chatbot.nlp.spacy_service import SpacyServicioPLN
from app.infrastructure.external.chatbot.nlp.openai_service import OpenAIServicioPLN
from app.infrastructure.external.chatbot.repository import PostgresRepositorioTarifas
from app.application.services.logistica import (
    LogisticaService,
