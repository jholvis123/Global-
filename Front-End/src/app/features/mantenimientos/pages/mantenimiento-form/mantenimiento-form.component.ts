    ...
    <div class="page-container">
      <div class="page-header">
        <div class="page-header__content">
          ...
          <div>
            <h1 class="page-header__title">Nuevo Mantenimiento</h1>
            <p class="page-header__subtitle">Programa un nuevo mantenimiento de vehículo</p>
          </div>
        </div>
      </div>
      <div class="coming-soon">
        ...
        <p>El formulario de mantenimiento estará disponible próximamente</p>
...
export class MantenimientoFormComponent {
  ...
  cancel(): void { this.router.navigate(['/app/mantenimientos']); }
}
